...
TARGET = fp
OBJECTS = main.o src/Point.o src/PointBase.o src/Vector.o src/Matrix.o src/Camera.o src/Texture_Utils.o src/Config_Utils.o src/Shader_Utils.o src/Skybox.o src/Map.o src/Hero.o src/Bubble.o src/BubbleSystem.o src/Bezier.o
